...
class GeneGraph:
    def __init__(self, edge_data_file, gene_attr_file):
        ...
        #        self.ids_unknown = gene_attr[gene_attr["class"] == 1].index.values
...
class TestDataGenerator(keras.utils.Sequence):
    ...
    def __init__(self, g: GeneGraph, nf: int, ns: List[int], batch_size: int = 250):
        """Initialization"""
        self.batch_size = batch_size
        self.g = g
        self.ids = g.ids_test
