...
pathRdata <- "results/adn/all_probes/rdata/E_GEOD_29652/"
pathtxt <- "results/adn/all_probes/txt/E_GEOD_29652/"
...
print("Wrting results to file.")
save(E_GEOD_29652_pr, file = "results/adn/all_probes/E_GEOD_29652_all_probes.RData")
